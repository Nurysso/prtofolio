...
export { vanishMetadata as metadata } from '@/lib/project-metadata';
...
export default function VanishClient() {
  ...
  const features = [
    {
      icon: Shield,
      title: 'Safe Deletion',
      desc: 'Files moved to cache, not permanently deleted',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: RotateCcw,
      title: 'Pattern Recovery',
      desc: 'Restore files using flexible pattern matching',
      color: 'from-purple-500 to-purple-600',
    },
    {
      icon: BarChart3,
      title: 'Rich Statistics',
      desc: 'Detailed insights into cache usage and metrics',
      color: 'from-pink-500 to-pink-600',
    },
    {
      icon: Palette,
      title: 'Beautiful TUI',
      desc: 'Modern interface with 8 built-in themes',
      color: 'from-orange-500 to-orange-600',
    },
    {
      icon: Zap,
      title: 'Fast Operations',
      desc: 'Optimized for large directories and files',
      color: 'from-yellow-500 to-yellow-600',
    },
    {
      icon: Settings,
      title: 'Configurable',
      desc: 'Extensive customization via TOML config',
      color: 'from-green-500 to-green-600',
    },
    {
      icon: FileText,
      title: 'Audit Trails',
      desc: 'Comprehensive logging of all operations',
      color: 'from-teal-500 to-teal-600',
    },
    {
      icon: Trash2,
      title: 'Auto Cleanup',
      desc: 'Configurable retention and purging policies',
        ...
        <section id="hero" className="w-full min-h-screen flex justify-center items-center py-20">
          <div className="text-center mt-20">
            <svg viewBox="0 0 500 200" className="w-full max-w-lg mx-auto -mb-4">
              <path id="curve" d="M 50 150 Q 250 130 450 150" fill="transparent" />
            ...
            <p className="text-xl font-jacques sm:text-2xl text-slate-300 mb-4 max-w-3xl mx-auto leading-relaxed">
              A modern, safe file deletion tool with recovery capabilities and beautiful TUI
              interface.
            </p>

            <p className="text-lg font-semibold mb-12" style={{ color: theme.accent }}>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: `linear-gradient(to bottom right, ${theme.accent}, transparent)`,
                    }}
                  ></div>
                  <div
              ...
              >
                ...
                {scene === 1 && typedCommand === command && (
                  <div className="space-y-4 animate-fade-in" style={{ color: theme.text }}>
                    ...
                    <div style={{ color: theme.text }}>
                      Press &apos;y&apos; to confirm, &apos;n&apos; to cancel, or &apos;q&apos; to
                      quit
                    </div>
                  </div>
                )}
                ...
                {scene === 2 && (
                  <div className="space-y-4 animate-fade-in" style={{ color: theme.text }}>
                    ...
                    <div
                      className="w-full h-4 border border-slate-700 rounded-full overflow-hidden"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-slate-300 text-sm">
                        Add a version tag like{' '}
                        <code
                          className="bg-slate-700 px-2 py-1 rounded font-mono text-xs"
                          style={{ color: theme.accent }}
                        >
                          v0.9.0
                        </code>{' '}
      ...
      <footer className="relative z-10 border-t border-slate-700/50 bg-slate-900/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-slate-400 text-sm mb-4 max-w-md">
                A modern, safe file deletion tool with recovery capabilities. Delete with
                confidence, restore with ease.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="https://github.com/Nurysso/vanish#readme"
                ...
                <li>
                  <a
                    href="https://github.com/Nurysso/vanish/releases"
                    className="text-slate-400 hover:text-white transition-colors text-sm flex items-center gap-2"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    href="https://github.com/Nurysso/vanish/pulls"
                    className="text-slate-400 hover:text-white transition-colors text-sm flex items-center gap-2"
                  >
          ...
          <div className="pt-8 border-t border-slate-700/50 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">© 2025 Vanish. Released under the MIT License.</p>
