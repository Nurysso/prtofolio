    ...
    <div className="min-h-screen bg-[#0a0e12] text-[#eaebed] relative overflow-hidden">
      ...
      <section className="relative pt-10 pb-40 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 text-6xl opacity-10" style={{ animation: 'float 10s ease-in-out infinite' }}>🌙</div>
          <div className="absolute top-40 right-20 text-6xl opacity-10" style={{ animation: 'float 12s ease-in-out infinite reverse' }}>✨</div>
          <div className="absolute bottom-40 left-1/4 text-6xl opacity-10" style={{ animation: 'float 15s ease-in-out infinite' }}>⚡</div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-24">
            <div className="inline-block mb-6">
              <div className="text-8xl mb-4" style={{ animation: 'bounce 3s ease-in-out infinite' }}>⚡</div>
            </div>
      ...
      <section className="relative py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-24">
            <div className="inline-block mb-6">
              <div className="text-8xl mb-4" style={{ animation: 'float 4s ease-in-out infinite' }}>📦</div>
            </div>
            <h2 className="text-6xl sm:text-8xl font-black mb-8 tracking-tighter" style={{ animation: 'neon 3s ease-in-out infinite' }}>
              SUPPORTED APPS
            </h2>
